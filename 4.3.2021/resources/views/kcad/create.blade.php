...
<button type="button" @if ($kcad->whereIn('progress_id',['0','1','2','4','6','7','8'])->count()>0) disabled @else onClick="$('#form_kcadhantarjawatankuasa').submit();" @endif class="btn btn-warning">Hantar Auditi</button>
