...
class UlasanpenemuanController extends Controller
{
    ...
    {
        $kcad = Laporan::where('status','kcad')->orderBy('id','desc')->paginate(10);
    ...
    public function create(Laporan $laporan)
    {
        ...
        $kcad = Penemuan::where('laporan_id', $laporan->id)->whereIn('progress_id',['1','3','4','5','8'])->paginate(10);
    ...
    public function kcadhantarjawatankuasa(Request $request)
    {
        ...
        $laporan->save();
        flash('Laporan telah berjaya dihantar kepada Auditi')->success()->important();
        return redirect(route('kcad.index'));
    }
}
