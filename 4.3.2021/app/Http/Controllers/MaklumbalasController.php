...
class MaklumbalasController extends Controller
{
    ...
    public function index()
    {
        ...
        }])->where('status','jawatankuasa')->orderBy('id','desc')->paginate(10);
    ...
    //public function downloadattachment(Attachment $attachments)
    //{
        //$downloads = Attachment::where('url', $attachments->attachable_id)->get();
