...
(function() {
    ...
    var s = (e.helpers = {}),
        ...
        y =
            ((s.calculateScaleRange = function(t, i, e, s, o) {
                ...
                var c = m(r),
                    u = g(r);
                u === c &&
                    ((u += 0.5), c >= 0.5 && !s ? (c -= 0.5) : (u += 0.5));
                for (
                    var d = Math.abs(u - c),
                        p = x(d),
                        f =
                            Math.ceil(u / (1 * Math.pow(10, p))) *
                            Math.pow(10, p),
                        v = s
                            ? 0
                            : Math.floor(c / (1 * Math.pow(10, p))) *
                              Math.pow(10, p),
                        S = f - v,
                        C = Math.pow(10, p),
                        y = Math.round(S / C);
        ...
        F = (s.getMaximumWidth = function(t) {
            var i = t.parentNode,
                e =
                    parseInt(R(i, "padding-left")) +
                    parseInt(R(i, "padding-right"));
            return i ? i.clientWidth - e : 0;
        }),
        A = (s.getMaximumHeight = function(t) {
            var i = t.parentNode,
                e =
                    parseInt(R(i, "padding-bottom")) +
                    parseInt(R(i, "padding-top"));
                    ...
                    if (
                        ...
                        if (this.datasets && this.datasets.length > 1) {
                            ...
                            new e.MultiTooltip({
                                ...
                                titleTextColor: this.options
                                    .tooltipTitleFontColor,
                                titleFontFamily: this.options
                                    .tooltipTitleFontFamily,
                                titleFontStyle: this.options
                                    .tooltipTitleFontStyle,
                                titleFontSize: this.options
                            ...
                            n(
                                ...
                                function(t) {
                                    ...
                                    new e.Tooltip({
                                        ...
                                        xPadding: this.options.tooltipXPadding,
                                        yPadding: this.options.tooltipYPadding,
                                        fillColor: this.options
                                            .tooltipFillColor,
                                        textColor: this.options
                                            .tooltipFontColor,
                                        fontFamily: this.options
                                            .tooltipFontFamily,
                                        fontStyle: this.options
                                            .tooltipFontStyle,
                                        fontSize: this.options.tooltipFontSize,
                                        caretHeight: this.options
                                            .tooltipCaretSize,
                                        cornerRadius: this.options
                                            .tooltipCornerRadius,
                                        text: y(
            ...
            buildScale: function(t) {
                var i = this,
                    ...
                    n = {
                        ...
                        showHorizontalLines: this.options
