                        ...
                        <div class="row" >
                            <div class="col-md-10">
                                <div class="form-group{{ $errors->has('jawatankuasa[]') ? ' has-error' : '' }}">
                                    ...
                                    <select @if($laporan->status =='jawatankuasa' || $jawatankuasaselected->user_id == $laporan->auditor || $jawatankuasaselected->user_id == $laporan->kcad) disabled  @endif name="jawatankuasa[]" id="" class="form-control " required>
                            ...
                            <div class="col-md-2">
                                <button type="button" @if($laporan->status =='jawatankuasa' || $jawatankuasaselected->user_id == $laporan->auditor || $jawatankuasaselected->user_id == $laporan->kcad ) disabled @endif class='btn btn-danger btn-block removeBtn'> <i class="fa fa-times"></i> Padam</button>
                            </div>
                        </div>
                        @endforeach
                    </div>
