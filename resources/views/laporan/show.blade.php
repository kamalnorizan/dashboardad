        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h3>Paparan Laporan</h3>
                </div>
                <div class="ibox-content">
                    {!! Form::hidden('laporan', $laporan->id, ['id'=>'laporan_id']) !!}
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group{{ $errors->has('tahun') ? ' has-error' : '' }}">
                                {!! Form::label('tahun', 'Tahun') !!}
                                {!! Form::text('tahun', $laporan->tahun, ['class' => 'form-control', 'required' => 'required','disabled']) !!}
                        ...
                        <div class="col-md-6">
                            <div class="form-group{{ $errors->has('organisasi_id') ? ' has-error' : '' }}">
                                ...
                                {!! Form::select('organisasi_id',$org_Opts,$laporan->organisasi_id, ['class' => 'form-control', 'required' => 'required','disabled']) !!}
                    ...
                    <div class="form-group{{ $errors->has('tajuk') ? ' has-error' : '' }}">
                        ...
                        {!! Form::text('tajuk', $laporan->tajuk, ['class' => 'form-control', 'required' => 'required','disabled']) !!}
                        ...
                        <div class="col-md-6" >
                          <div class="form-group{{ $errors->has('tarikh') ? ' has-error' : '' }}">
                            ...
                            <div class="input-group date datepicker">
                                <input disabled type="text" class="form-control" id="tarikh" name="tarikh" value="{{ Carbon\Carbon::parse($laporan->tarikh)->format('Y-m-d') }}">
                    ...
                    <div class="row">
                        <div class="col-md-6" >
                            <div class="form-group{{ $errors->has('kategori_id') ? ' has-error' : '' }}">
                                ...
                                {!! Form::select('kategori_id',$kategori_opts, $selectedkategori->id, ['disabled', 'class' => 'form-control', 'required' => 'required']) !!}
                        ...
                        <div class="col-md-6 @if($selectedkategori->subkategoriad->count()==0) hidden @endif" id="subkategori_col">
                            <div class="form-group{{ $errors->has('subkategori') ? ' has-error' : '' }}">
                                ...
                                {!! Form::select('subkategori',$subkategori_opts, $selectedsubkategori->id, ['disabled', 'class' => 'form-control']) !!}
                                <small class="text-danger">{{ $errors->first('subkategori') }}</small>
                            </div>
                        </div>
                    </div>
                    <div id="jawatankuasaDiv disabled">
                        <div class="row" >
                            <div class="col-md-12">
                                <div class="form-group{{ $errors->has('jawatankuasa[]') ? ' has-error' : '' }}">
                                    {!! Form::label('jawatankuasa[]', 'Ahli Jawatankuasa') !!} <button disabled type="button" id="tambahAhli" class="btn btn-xs btn-primary"><i class="fa fa-plus"></i> Tambah</button>
                        ...
                        <div class="row" >
                            ...
                            <div class="col-md-2">
                                <button type="button" @if($laporan->status =='jawatankuasa' || $jawatankuasaselected->user_id == $laporan->auditor || $jawatankuasaselected->user_id == $laporan->kcad ) disabled @endif class='btn btn-danger btn-block removeBtn disabled'> <i class="fa fa-times"></i> Padam</button>
                            </div>
                        </div>
                        @endforeach
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div  class="form-group{{ $errors->has('attachment') ? ' has-error' : '' }}">
                                ...
                                {!! Form::file('attachment',null,$laporan->attachment->url,['required' => 'required','disabled'] ) !!}
                    ...
                    <div class="btn-group pull-right">
                        ...
                        <a href="{{ route('kcad.index', ['laporan' => $laporan->id] ) }}" class="btn btn-success">Tutup</a>
                    </div>
                    <br>
                        <br>
                    {!! Form::close() !!}
